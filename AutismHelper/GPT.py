...
def LoadGPTResponse():
    ...
    # 上传信息
    with open('/Library/WebServer/Documents/AutismHelper/inputCombined.txt', 'r') as f:
        ...
        with open('/Library/WebServer/Documents/AutismHelper/textResponse.txt', 'w', encoding='utf-8') as f: 
